...
import com.faxlistener.listenerpoc.MainClass;
import com.faxlistener.model.StorageObject;
...
//        return message -> {
////        StorageObject storageObject = new Gson().fromJson(new String(), StorageObject.class);
...
//            }
//            LOGGER.info("Message arrived! Payload: " + storageObject.getName());
